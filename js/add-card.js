...
function addCard4(heading, btnText, funcName) {
  card_id++; 
  var myCol = $(`<div class="col-lg-4 col-md-6" id="mycol"></div>`);
  var myPanel = $(`<div class="card" id="util-card-` + card_id + `" style="margin-top: 1rem; width: 105%;">
    <div class="card-body">
      ...
      <textarea placeholder="Input" style="height: 3rem; width: 100%;" id="input-text-area-` + card_id + `"></textarea>
      <a href="#" class="btn btn-primary" onclick="` + funcName + `('` + card_id + `')">` + btnText+ `</a>
      <div class="qr-code" id="qrcode-` + card_id + `"></div>
    </div>
  </div>`);
...
function addCard5(heading, btnText, funcName) {
  card_id++; 
  var myCol = $(`<div class="col-lg-4 col-md-6" id="mycol"></div>`);
  var myPanel = $(`<div class="card" id="util-card-` + card_id + `" style="margin-top: 1rem; width: 105%;">
    <div class="card-body">
      ...
      <textarea placeholder="Input" style="height: 5rem; width: 100%;" id="input-text-area-` + card_id + `"></textarea>
      <textarea placeholder="Secret key" style="height: 2rem; width: 100%;" id="input-key-text-area-` + card_id + `"></textarea>
      <textarea readonly style="height: 5rem; width: 100%;" id="text-area-` + card_id + `"></textarea>
      <a href="#" class="btn btn-primary" onclick="` + funcName + `('` + card_id + `')">` + btnText+ `</a>
    </div>
  </div>`);
